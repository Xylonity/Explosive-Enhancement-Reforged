...
public class UnderwaterSparksParticle extends SingleQuadParticle {

    private final SpriteSet sprites;

    UnderwaterSparksParticle(ClientLevel level, double x, double y, double z, SpriteSet sprites, double velX, double velY, double velZ) {
